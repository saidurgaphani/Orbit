    ...
    <div className="min-h-screen bg-alabaster text-charcoal flex flex-col items-center justify-center p-6 select-none relative overflow-hidden">
      ...
      <div className="w-full max-w-md border border-charcoal p-8 md:p-10 bg-alabaster shadow-[4px_4px_0px_0px_rgba(39,39,39,1)] relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="flex flex-col">
            ...
            <input
              ...
              placeholder="e.g. Sai Durgha Phani"
              required
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-charcoal text-alabaster border border-charcoal py-3.5 px-4 hover:bg-forest hover:border-forest transition-colors font-mono font-bold text-xs uppercase tracking-[0.2em] mt-3"
          >
            {loading ? 'Initializing System...' : 'Initialize Personal Platform'}
          </button>
        </form>
        ...
        <div className="mt-8 text-center text-[10px] font-mono uppercase tracking-wider text-charcoal/50">
          Already registered?{' '}
          <Link to="/auth/login" className="text-forest hover:underline font-bold">
            Identify yourself
          </Link>
        </div>
      </div>
