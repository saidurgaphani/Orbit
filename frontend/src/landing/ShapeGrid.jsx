...
const ShapeGrid = ({
  ...
  // IntersectionObserver to auto-pause offscreen rendering loops
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      // Vignette effect - fades out into the alabaster page background
      ...
      gradient.addColorStop(0, 'rgba(251, 251, 249, 0)');
      gradient.addColorStop(1, 'rgba(251, 251, 249, 0.95)');
  ...
  }, [direction, speed, borderColor, hoverFillColor, squareSize, shape, hoverTrailAmount, inView]);
